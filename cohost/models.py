...
class Data(models.Model):
    ...
    ips_id = models.ForeignKey("Ips", null=True, blank=True, db_column="ip_id") # Field name made lowercase.
    ...
    IPS_net = models.CharField(u"运营商", max_length=16, null=True, blank=True, db_column="IPS")
    #备案号
