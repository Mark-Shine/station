...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActionRecord.message'
        db.alter_column(u'cohost_actionrecord', 'message', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ActionRecord.message'
        db.alter_column(u'cohost_actionrecord', 'message', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
