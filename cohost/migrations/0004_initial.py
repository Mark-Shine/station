...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('AllKey', (
            ...
            ('keyname', self.gf('django.db.models.fields.TextField')(unique=True, db_column='KeyName')),
        ...
        db.create_table('Data', (
            ...
            ('reg_number', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('reg_type', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='0', max_length=32, null=True, blank=True)),
